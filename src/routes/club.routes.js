...
import { createClub, getClubs, getPlayersByClub, approveClub, rejectClub, getTeamsByClub, getClubDetails } from "../controllers/club.controller.js";
...
router.route("/getClubDetails/:managerId/club").get(getClubDetails)
